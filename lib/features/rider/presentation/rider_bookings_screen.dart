...
import 'package:bykea_skardu/features/rider/presentation/rider_booking_detail_screen.dart';
...
class _RiderBookingsScreenState extends State<RiderBookingsScreen> {
  ...
  void initState() {
    ...
    super.initState();
    context.read<RiderBloc>().add(LoadRiderBookingsEvent());
  }
  @override
          ...
          return InkWell(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => RiderBookingDetailScreen(
                    ride: ride,
                  ),
                ),
              );
